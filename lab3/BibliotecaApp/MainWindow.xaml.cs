...
namespace BibliotecaApp
{
    public partial class MainWindow : Window
    {
        ...
        private void LoadData()
        {
            try
            {
                // EF Core handles the retrieval and mapping automatically
        ...
        private void RefreshBooksGrid()
        {
            if (dgAuthors.SelectedItem is Author selectedAuthor)
            {
                try
                {
                    // This will now use Eager Loading (.Include) internally to fetch categories as well
        ...
        private void dgBooks_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (dgBooks.SelectedItem is Book selectedBook)
            {
                ...
                // Match the proxy entities loaded by EF Core with the UI ListBox items
        ...
        private bool ValidateInput(out int validYear)
        {
            ...
            // Validating up to the current year
        ...
        private void btnAdd_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                // Creating a detached entity to pass to the repository
                ...
                // Extract IDs to let the repository build the M:N relations safely
        ...
        private void btnUpdate_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                // Updating the detached entity properties before sending it to the repository
        ...
        {
            // Opens the test window modelessly to allow interaction with both windows
