...
> **Rulare Demo E1 (Deadlock). Please wait...
--- E1. DEMO DEADLOCK (ERROR) ---
Transaction B: BEGIN TRANSACTION
Transaction B: Locked Book Id=13. Waiting 2 seconds...
Transaction A: BEGIN TRANSACTION
Transaction A: Locked Book Id=12. Waiting 2 seconds...
Transaction A: Attempting to lock Book Id=13...
Transaction B: Attempting to lock Book Id=12...
Transaction B: COMMIT successful.
Transaction A FAILED with Deadlock: deadlock detected
---------------------------------

Rulare Demo E2 (Deadlock Resolved). Please wait...
--- E2. DEMO DEADLOCK (RESOLVED) ---
Transaction A: BEGIN TRANSACTION
Transaction A: Locked Book Id=12. Waiting 2 seconds...
Transaction B: BEGIN TRANSACTION
Transaction B: Attempting to lock Book Id=12 (will wait for TxA)...
Transaction A: Attempting to lock Book Id=13...
Transaction A: COMMIT successful.
Transaction B: Locked Book Id=12.
Transaction B: Attempting to lock Book Id=13...
Transaction B: COMMIT successful.
------------------------------------**
